...
import gamas.dev.simplecalendar.model.DayOfWeek;
import gamas.dev.simplecalendar.model.Month;
import gamas.dev.simplecalendar.selection.selectionbar.SelectionBarContentItem;
import gamas.dev.simplecalendar.selection.selectionbar.SelectionBarItem;
import gamas.dev.simplecalendar.selection.selectionbar.SelectionBarTitleItem;
...
public final class CalendarUtils {
     ...
     *
     * @param selectedDays selected days list to be grouped
     * @return selected days grouped by month/year
     */
     ...
     *
     * @return width of circle in pixels
     */
