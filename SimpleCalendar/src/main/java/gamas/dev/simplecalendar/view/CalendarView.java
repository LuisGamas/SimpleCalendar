package gamas.dev.simplecalendar.view;
...
import gamas.dev.simplecalendar.FetchMonthsAsyncTask;
import gamas.dev.simplecalendar.R;
import gamas.dev.simplecalendar.adapter.MonthAdapter;
import gamas.dev.simplecalendar.listeners.OnMonthChangeListener;
...
import gamas.dev.simplecalendar.selection.NoneSelectionManager;
import gamas.dev.simplecalendar.selection.OnDaySelectedListener;
import gamas.dev.simplecalendar.selection.RangeSelectionManager;
import gamas.dev.simplecalendar.selection.SingleSelectionManager;
import gamas.dev.simplecalendar.selection.selectionbar.MultipleSelectionBarAdapter;
import gamas.dev.simplecalendar.selection.selectionbar.SelectionBarItem;
import gamas.dev.simplecalendar.settings.SettingsManager;
import gamas.dev.simplecalendar.settings.appearance.AppearanceInterface;
import gamas.dev.simplecalendar.settings.date.DateInterface;
import gamas.dev.simplecalendar.settings.lists.CalendarListsInterface;
...
import gamas.dev.simplecalendar.settings.selection.SelectionInterface;
import gamas.dev.simplecalendar.utils.CalendarUtils;
import gamas.dev.simplecalendar.utils.SelectionType;
import gamas.dev.simplecalendar.utils.WeekDay;
import gamas.dev.simplecalendar.utils.snap.GravitySnapHelper;
import gamas.dev.simplecalendar.view.customviews.CircleAnimationTextView;
import gamas.dev.simplecalendar.view.customviews.SquareTextView;
...
public class CalendarView extends RelativeLayout implements OnDaySelectedListener,
     ...
     *
     * @param typedArray TypedArray to handle attributes from xml file
     */
    private void handleAttributes(TypedArray typedArray) {
        ...
        int currentDayIconRes = typedArray.getResourceId(R.styleable.CalendarView_currentDayIconRes, R.drawable.ic_triangle_colored);
...
//        flBottomSelectionBar.setLayoutTransition(new LayoutTransition());
     ...
     *
     * @return all selected days or empty list
     */
     ...
     *
     * @return all selected dates or empty list
     */
    ...
    private void displaySelectedDaysRange() {
        if (selectionManager instanceof RangeSelectionManager) {
            ...
            if (days != null) {
                ...
                tvStartRangeTitle.setText(CalendarUtils.getYearNameTitle(days.first).toUpperCase(/*Locale.ROOT*/));
                ...
                tvEndRangeTitle.setText(CalendarUtils.getYearNameTitle(days.second).toUpperCase(/*Locale.ROOT*/));
     ...
     *
     * @return true if we need to show range of selected days in bottom selection bar
     */
