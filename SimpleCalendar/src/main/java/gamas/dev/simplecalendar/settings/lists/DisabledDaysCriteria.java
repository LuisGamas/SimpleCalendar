...
public class DisabledDaysCriteria {
     ...
     *
     * @param startRange start range of disabled days (1-31) inclusive (default: 1) (optional)
     * @param endRange   end range of disabled days (1-31) inclusive (default: 31) (optional)
     */
